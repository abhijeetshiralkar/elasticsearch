...
set DATABASE_HOST=10.22.146.47
set DATABASE_PORT=7001
...
set ELASTICSEARCH_HOST=https://156661a435deb75f51f74f350f0cad78.us-east-1.aws.found.io:443
set ELASTICSEARCH_USER=elastic
set ELASTICSEARCH_PASSWORD=2bXoTreRlRMfjGBrD5KQ1OcG
set ELASTICSEARCH_USER_PASSWORD=elastic:2bXoTreRlRMfjGBrD5KQ1OcG
...
set LOGSTASH_SQL_FILEPATH=D:\ElasticSearch\data\MX\PROD\SQL
...
set IMPRODUCT_INDEX_NAME=%INDEX_NAME_PREFIX%-%CURRENT_DATETIME%
