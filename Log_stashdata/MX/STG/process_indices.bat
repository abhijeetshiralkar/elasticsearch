...
set DATABASE_HOST=10.22.146.61
...
set LOGSTASH_SQL_FILEPATH=D:\ElasticSearch\data\MX\STG\SQL
...
rem In case of ERROR in the log file we have to handle the error situation, in case of cloud instance retrial issue , it will also fail the execution.
